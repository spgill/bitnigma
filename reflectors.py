...
class _ReflectorBase(rotors._RotorBase):
    ...
    def invalid(self):
        ...
        raise RuntimeError('You called an invalid function for reflectors.')
...
class ByteReflectorA(_ReflectorBase):
    _name = 'Reflector A'
    _short = 'refa'
...
class ByteReflectorB(_ReflectorBase):
    _name = 'Reflector B'
    _short = 'refb'
...
class ByteReflectorC(_ReflectorBase):
    _name = 'Reflector C'
    _short = 'refc'
